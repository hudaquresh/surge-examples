...
def setplot(plotdata=None):
    ...
    def gauge_afteraxes(cd):
        ...
        axes.set_xticklabels([r"$0$", r"$1$", r"$2$", r"$3$", r"$4$"])
        axes.grid(True)
    ...
    plotaxes.scaled = True
    plotaxes.xlimits = [-85, -75]
    plotaxes.ylimits = [20.0, 25.0]
    ...
    plotdata.print_gaugenos = range(0, 24)   # list of gauges to print
